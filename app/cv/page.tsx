...
import { ArrowLeft, Download, Mail, Github, Linkedin, Phone } from 'lucide-react';
    ...
    <main className="relative min-h-screen bg-[#020817] text-[#e2e8f0]">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-[#020817]/90 backdrop-blur-xl border-b border-[#00d4ff]/10">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <a href="/suraj-cv.pdf" download="Suraj_Yadav_CV.pdf">
            <motion.button
              className="flex items-center gap-2 rounded-full px-5 py-2.5 bg-[#00d4ff]/10 border border-[#00d4ff]/40 text-[#00d4ff] hover:bg-[#00d4ff]/20 hover:border-[#00d4ff]/80 transition-all duration-300"
              whileHover={{ scale: 1.04 }}
              whileTap={{ scale: 0.96 }}
              style={{ boxShadow: '0 0 20px rgba(0, 212, 255, 0.15)' }}
            >
              <Download size={16} />
              <span className="font-orbitron text-xs tracking-wider uppercase">Download PDF</span>
            </motion.button>
          </a>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 pt-28 pb-20">
        ...
        >
          <a href="/suraj-cv.pdf" download="Suraj_Yadav_CV.pdf">
            ...
            >
              <Download size={18} />
              <span className="font-orbitron text-sm tracking-wider uppercase">Download Full CV as PDF</span>
            </motion.button>
          </a>
        </motion.div>
      </div>
