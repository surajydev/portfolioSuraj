...
export default function ContactSection() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center py-16 max-w-[800px] mx-auto">
      <StaggerChild className="mb-4 text-center">
        <h2 className="font-orbitron text-2xl md:text-3xl font-bold text-[#00d4ff] text-glow-cyan uppercase">
          Get In Touch
        </h2>
      </StaggerChild>

      <StaggerChild className="mb-10 text-center">
        <p className="font-exo text-[#94a3b8]">Let&apos;s build something amazing together.</p>
      </StaggerChild>

      {/* Contact Info Cards */}
      <StaggerChild className="w-full mb-10">
